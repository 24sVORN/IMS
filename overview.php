...
if (isset($_SESSION['alert'])) {
    ?>
    <div
        class="absolute right-5 top-1 mx-auto w-52 text-center rounded-md bg-[#313e2c] text-[#aaec8a] shadow-lg transform translate-x-7 opacity-0 invisible animate-fade-in">
        <div class="flex justify-center items-center px-2 py-4">
            <img src="assets/check-circle.svg" alt="Success" class="h-6 w-6 mr-1">
    ...
    <div
        ...
        <div
            ...
            <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                <!-- Grid -->
                <div class="grid sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 ">
                    <!-- Card -->
                    <div
                        class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-[#13141a] dark:border-neutral-700">
                        <div class="p-4 md:p-5">
                            ...
                            <div class="mt-1 flex items-center gap-x-2">
                                ...
                                <span class="flex items-center gap-x-1 text-green">
                ...
                <div class="grid lg:grid-cols-2 gap-4 sm:gap-6">
                    <!-- Card -->
                    <div
                        class="p-4 md:p-5 min-h-[410px] flex flex-col bg-white border shadow-sm rounded-xl dark:bg-[#13141a] dark:border-neutral-700">
                        <!-- Header -->
                ...
                <div class="flex flex-col">
                    <div class="-m-1.5 overflow-x-auto">
                        <div class="p-1.5 min-w-full inline-block align-middle">
                            <div
                                class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-[#13141a] dark:border-neutral-700">
                                <!-- Header -->
                                <div
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                    <thead class="bg-gray-50 dark:bg-[#13141a]">
                                        <tr>
